...
export function LoginForm() {
  ...
  const { handleGoogleOAuth, isDisabled: isGoogleDisabled, isAvailable: isGoogleAvailable } = useGoogleOAuth({
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full py-3 px-4 border-2 text-gray-900 font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-colors flex items-center justify-center gap-2 ${
                isGoogleAvailable
                  ? 'border-gray-400 hover:bg-gray-50'
                  : 'border-gray-300 bg-gray-50 text-gray-400 cursor-not-allowed'
              }`}
              disabled={isGoogleDisabled || !isGoogleAvailable}
            >
              ...
              {isGoogleAvailable ? 'Sign in with Google' : 'Sign in with Google (coming soon)'}
            </button>
          </form>
